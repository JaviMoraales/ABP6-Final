...
public class Select {
	...
	//Sintaxis 1
	public static void selectAllFromNombreTabla() {
		
	}
	
	//Sintaxis 2
	public static void selectNombresCamposFrom() {
	...
	public static boolean comprobarSelect(String comando) {
	...
	public static boolean comprobarSelectAll(String comando) {
	...
	public static boolean comprobarSelectNombreCamposFrom(String comando) {
		nombreTabla="";
		...
		try {
			if ((comando.charAt(comando.lastIndexOf("from")-1)!=' ')&&(comando.charAt(comando.lastIndexOf("from")+4)!=' ')) {
				return false;
			}
